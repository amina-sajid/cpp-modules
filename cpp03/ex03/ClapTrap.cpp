...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/29 17:18:09 by asajid            #+#    #+#             */
/*   Updated: 2023/12/30 16:50:15 by asajid           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << "ClapTrap attacked and lost " << amount << " hit points, he now has " << this->hitPoints << " hit points." << std::endl;
}
