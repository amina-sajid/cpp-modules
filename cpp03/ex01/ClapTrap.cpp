...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/29 16:03:54 by asajid            #+#    #+#             */
/*   Updated: 2023/12/30 16:49:31 by asajid           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	{
		std::cout << "ClapTrap is already dead, stop beating it." << std::endl;
		return ;
	}
	std::cout << "ClapTrap was attacked and lost " << amount << " hit points, he now has " << this->hitPoints << " hit points." << std::endl;
}
